...
<body>
	...
	<div>
		<div class="container">
			...
			<h3 class="title_">2023년 4월 1일 기준 더조은대학교의 학교 현황입니다.</h3>

			<h2 class="list_cb">대학구성</h2>
			<div class="flex j-center">
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td colspan="5" class="bb">※ 인공지능융합, 언더우드국제, 글로벌인재대학은 신촌캠퍼스
								및 국제캠퍼스에 각각 집계</td>
						</tr>
					</tbody>
				</table>
			...
			<h2 class="list_cb">재학생 수 (외국인 재학생수)</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 20%">
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="bb">※ 외국인연수생은 교환·방문학생 및 어학연수 형태로 수학중인
								학생들임<br>※ 석·박사통합과정 학생은 박사과정으로 편성함
							</td>
						</tr>
					</tbody>
				</table>
			...
			<h2 class="list_cb">국제교류 현황 (2022년)</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 20%">
			...
			<h2 class="list_cb">교원 현황 (외국인 교원수)</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 40%">
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="bb">※ 전임교원수에서 총장은 제외됨</td>
						</tr>
					</tbody>
				</table>
			</div>

			<h2 class="list_cb">직원 현황</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 50%">
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="bb">※부속병원 소속 직원은 제외함</td>
						</tr>
					</tbody>
				</table>
			</div>

			<h2 class="list_cb">부설연구기관 현황</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 30%">
			...
			<h2 class="list_cb">개설 강좌수(2023-1학기, 정규과목)</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 20%">
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="bb">※ 영어강의에는 원어강의도 포함됨</td>
						</tr>
					</tbody>
				</table>
			</div>

			<h2 class="list_cb">기숙사 현황</h2>
			<div class="flex j-center">
				<table class="table">
					<colgroup>
						<col style="width: 45%">
			...
			<h2 class="list_cb">학위수여자 수</h2>
			<div class="flex j-center last">
				<table class="table">
					<colgroup>
						<col style="width: 20%">
						<col style="width: 50%">
